                        ...
                        <Task
                            ...
                            type={
                                <InputCheckTask helpText={''} startNum={0}
                                    ...
                                    text={
                                        [
                                            'The first on our list is simple and, quite frankly, it makes your life easier. Have you ever heard: “Less is more”? Well, being minimal is just that. You find just the right amount of visuals and information to get your point across without overdoing it. Look at these slides here. They look clean; they make you {inputs[0]}. Too much information or visuals everywhere can create {inputs[1]}. The trick – not being boring you must find the right {inputs[2]} between simple yet intriguing. Now, one rule that {inputs[3]} is having one standard transition between slides. I get it. You want to be creative and have fun when creating your slides but do your audience a {inputs[4]} and have all of your slides transition {inputs[5]} just like we have here. Whatever you do, don’t have one transition moving {inputs[6]}, the next backwards, the next faded in. You get the point. By having one {inputs[7]} transition style you create a flow that will be easy for your {inputs[8]} to adjust to. And why keep it to just your slides? Once you’re comfortable, try adding horizontal transitions to your text and visual elements as well - for added appeal. When your presentation starts to become flooded with information, a good idea is to throw in a slide of a related quote. It helps break up your presentation giving your viewers a breather of sorts. Think of it as a {inputs[9]}. Just make sure that the quote fits in with the rest of your presentation. It’s supposed to be a breather not a wrench confusing your onlookers.'
                                        ]
                                    }
