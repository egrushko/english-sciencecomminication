                    ...
                    <Task 
                        ...
                        type={
                            <CompareTextTask startNum = {0}
                                ...
                                answers={['Too much information on a slide','Hard to read fonts','Color','Overusing bullet lists','Animations','Slide transitions','Pointing tools','Equipment used for presentation','Extra paragraph']}
                                rightAnswers={['Animations','Pointing tools','Too much information on a slide',['Extra paragraph','-'],'Hard to read fonts','Color','Slide transitions','Overusing bullet lists','Equipment used for presentation']} 
                                headings={[
